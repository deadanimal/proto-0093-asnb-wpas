...
@Component({
  selector: "app-investor-analysis",
  templateUrl: "./investor-analysis.component.html",
  styleUrls: ["./investor-analysis.component.scss"],
})
export class InvestorAnalysisComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  initChart() {
    ...
    chart.data = [
      {
        country: "Strategy Initiative",
        litres: 301.9,
      },
      {
        country: "Facility Update",
        litres: 165.8,
      },
      {
        country: "Human Capital Initiative",
        litres: 139.9,
      },
    ];
  }
